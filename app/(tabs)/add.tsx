...
import {
  ...
  ScrollView, Alert, Image, Platform, Modal, FlatList,
...
// ── Main Screen ───────────────────────────────────────────────────────────────
type AddContactScreenNavigationProp = NativeStackNavigationProp<RootStackParamList>;
          ...
          <View style={styles.card}>
            ...
            <View style={[styles.fieldRow, styles.rowBorder]}>
              ...
              <View style={styles.fieldBox}>
                ...
                <View style={styles.fieldInner}>
                  <TextInput
                    style={styles.fieldInput} value={form.firstName}
                    onChangeText={set('firstName')} placeholder="First Name"
                    placeholderTextColor="#B0B0B8" autoCapitalize="words"
                  />
            ...
            <View style={styles.fieldRow}>
              ...
              <View style={styles.fieldBox}>
                ...
                <View style={styles.fieldInner}>
                  <TextInput
                    style={styles.fieldInput} value={form.lastName}
          ...
          <View style={styles.card}>
            <View style={styles.fieldRow}>
              ...
              <View style={styles.fieldBox}>
                ...
                <View style={styles.fieldInner}>
                  <TextInput
                    style={styles.fieldInput} value={form.phone}
                    onChangeText={set('phone')} placeholder="+1 (000) 000-0000"
                    placeholderTextColor="#B0B0B8" keyboardType="phone-pad"
                  />
          ...
          <View style={styles.card}>
            <View style={styles.fieldRow}>
              ...
              <View style={styles.fieldBox}>
                ...
                <View style={styles.fieldInner}>
                  <TextInput
                    style={styles.fieldInput} value={form.email}
                    onChangeText={set('email')} placeholder="email@example.com"
                    placeholderTextColor="#B0B0B8" keyboardType="email-address"
                    autoCapitalize="none"
                  />
          ...
          <View style={styles.card}>
            <View style={styles.fieldRow}>
              ...
              <View style={styles.fieldBox}>
                ...
                <View style={styles.fieldInner}>
                  <TextInput
                    style={styles.fieldInput} value={form.company}
                    onChangeText={set('company')} placeholder="Company"
                    placeholderTextColor="#B0B0B8" autoCapitalize="words"
                  />
                </View>
              </View>
          ...
          <View style={styles.card}>
            <View style={[styles.fieldRow, styles.rowBorder]}>
              ...
              <View style={styles.fieldBox}>
                ...
                <View style={styles.fieldInner}>
                  <TextInput
                    style={styles.fieldInput} value={form.state}
                    onChangeText={set('state')} placeholder="State"
                    placeholderTextColor="#B0B0B8" autoCapitalize="words"
                  />
                </View>
              </View>
            ...
            <View style={[styles.fieldRow, styles.rowBorder]}>
              ...
              <View style={styles.fieldBox}>
                ...
                <View style={styles.fieldInner}>
                  <TextInput
                    style={styles.fieldInput} value={form.city}
                    onChangeText={set('city')} placeholder="City"
                    placeholderTextColor="#B0B0B8" autoCapitalize="words"
                  />
                </View>
              </View>
            ...
            <View style={styles.fieldRow}>
              ...
              <View style={styles.fieldBox}>
                ...
                <View style={styles.fieldInner}>
                  <TextInput
                    style={styles.fieldInput} value={form.street}
                    onChangeText={set('street')} placeholder="Street"
                    placeholderTextColor="#B0B0B8" autoCapitalize="words"
                  />
                </View>
              </View>
              ...
              <View style={styles.fieldBox}>
                ...
                <View style={styles.fieldInner}>
                  <TextInput
                    ...
                    value={age} editable={false}
                    placeholder="Auto-calculated" placeholderTextColor="#B0B0B8"
                  />
                </View>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  headerBtnText:{ color: THEME, fontSize: 16 },
